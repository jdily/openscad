...
class stree {
	...
	public:
      ...
      class leaf_iterator;
		...
		stree();
		stree(const T&);
		stree(const iterator_base&);
		stree(const stree<T, tree_node_allocator>&);
		~stree();
		stree<T,tree_node_allocator>& operator=(const stree<T, tree_node_allocator>&);
      ...
      sibling_iterator move_before(sibling_iterator target, sibling_iterator source);
		...
		stree     subtree(sibling_iterator from, sibling_iterator to) const;
		void     subtree(stree&, sibling_iterator from, sibling_iterator to) const;
	   ...
	   void     swap(iterator, iterator);
		...
		class iterator_base_less {
			public:
				bool operator()(const typename stree<T, tree_node_allocator>::iterator_base& one,
									 const typename stree<T, tree_node_allocator>::iterator_base& two) const
					{
	...
	private:
		...
		void copy_(const stree<T, tree_node_allocator>& other);
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::stree() 
	{
	head_initialise_();
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::stree(const T& x) 
	{
	head_initialise_();
	set_head(x);
	}
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::stree(const iterator_base& other)
	{
	head_initialise_();
	set_head((*other));
	replace(begin(), other);
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::head_initialise_() 
   { 
...
template <class T, class tree_node_allocator>
stree<T,tree_node_allocator>& stree<T, tree_node_allocator>::operator=(const stree<T, tree_node_allocator>& other)
	{
	if(this != &other)
		copy_(other);
	return *this;
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::stree(const stree<T, tree_node_allocator>& other)
	{
	head_initialise_();
	copy_(other);
	}
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::copy_(const stree<T, tree_node_allocator>& other) 
	{
	clear();
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::clear()
	{
	if(head)
...
template<class T, class tree_node_allocator> 
void stree<T, tree_node_allocator>::erase_children(const iterator_base& it)
	{
...
template<class T, class tree_node_allocator> 
template<class iter>
iter stree<T, tree_node_allocator>::erase(iter it)
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::pre_order_iterator stree<T, tree_node_allocator>::begin() const
	{
	return pre_order_iterator(head->next_sibling);
	}

template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::pre_order_iterator stree<T, tree_node_allocator>::end() const
	{
	return pre_order_iterator(feet);
	}

template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::breadth_first_queued_iterator stree<T, tree_node_allocator>::begin_breadth_first() const
	{
	return breadth_first_queued_iterator(head->next_sibling);
	}

template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::breadth_first_queued_iterator stree<T, tree_node_allocator>::end_breadth_first() const
	{
	return breadth_first_queued_iterator();
	}

template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::post_order_iterator stree<T, tree_node_allocator>::begin_post() const
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::post_order_iterator stree<T, tree_node_allocator>::end_post() const
	{
	return post_order_iterator(feet);
	}

template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::fixed_depth_iterator stree<T, tree_node_allocator>::begin_fixed(const iterator_base& pos, unsigned int dp) const
	{
	typename stree<T, tree_node_allocator>::fixed_depth_iterator ret;
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::fixed_depth_iterator stree<T, tree_node_allocator>::end_fixed(const iterator_base& pos, unsigned int dp) const
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::begin(const iterator_base& pos) const
	{
	assert(pos.node!=0);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::end(const iterator_base& pos) const
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::leaf_iterator stree<T, tree_node_allocator>::begin_leaf() const
   {
   tree_node *tmp=head->next_sibling;
   if(tmp!=feet) {
      while(tmp->first_child)
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::leaf_iterator stree<T, tree_node_allocator>::end_leaf() const
   {
   return leaf_iterator(feet);
   }

template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::leaf_iterator stree<T, tree_node_allocator>::begin_leaf(const iterator_base& top) const
   {
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::leaf_iterator stree<T, tree_node_allocator>::end_leaf(const iterator_base& top) const
   {
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::parent(iter position) 
	{
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::previous_sibling(iter position) const
	{
	assert(position.node!=0);
	iter ret(position);
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::next_sibling(iter position) const
	{
	assert(position.node!=0);
	iter ret(position);
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::next_at_same_depth(iter position) const
	{
	// We make use of a temporary fixed_depth iterator to implement this.

	typename stree<T, tree_node_allocator>::fixed_depth_iterator tmp(position.node);
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::append_child(iter position)
 	{
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::prepend_child(iter position)
 	{
	assert(position.node!=head);
	assert(position.node!=feet);
	assert(position.node);
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::append_child(iter position, const T& x)
	{
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::prepend_child(iter position, const T& x)
	{
	assert(position.node!=head);
	assert(position.node!=feet);
	assert(position.node);
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::append_child(iter position, iter other)
	{
	assert(position.node!=head);
	assert(position.node!=feet);
	assert(position.node);
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::prepend_child(iter position, iter other)
	{
	assert(position.node!=head);
	assert(position.node!=feet);
	assert(position.node);
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::append_children(iter position, sibling_iterator from, sibling_iterator to)
	{
	assert(position.node!=head);
	assert(position.node!=feet);
	assert(position.node);
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::prepend_children(iter position, sibling_iterator from, sibling_iterator to)
	{
	assert(position.node!=head);
	assert(position.node!=feet);
	assert(position.node);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::pre_order_iterator stree<T, tree_node_allocator>::set_head(const T& x)
	{
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::insert(iter position, const T& x)
	{
	if(position.node==0) {
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::insert(sibling_iterator position, const T& x)
	{
	tree_node* tmp = alloc_.allocate(1,0);
	alloc_.construct(tmp, x);
//	kp::constructor(&tmp->data, x);
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::insert_after(iter position, const T& x)
	{
	tree_node* tmp = alloc_.allocate(1,0);
	alloc_.construct(tmp, x);
//	kp::constructor(&tmp->data, x);
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::insert_subtree(iter position, const iterator_base& subtree)
	{
	// insert dummy
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::insert_subtree_after(iter position, const iterator_base& subtree)
	{
	// insert dummy
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::replace(iter position, const T& x)
	{
...
template <class T, class tree_node_allocator>
template <class iter>
iter stree<T, tree_node_allocator>::replace(iter position, const iterator_base& from)
	{
	assert(position.node!=head);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::replace(
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::flatten(iter position)
	{
	if(position.node->first_child==0)
		return position;
...
template <class T, class tree_node_allocator>
template <typename iter>
iter stree<T, tree_node_allocator>::reparent(iter position, sibling_iterator begin, sibling_iterator end)
	{
...
template <class T, class tree_node_allocator>
template <typename iter> iter stree<T, tree_node_allocator>::reparent(iter position, iter from)
	{
...
template <class T, class tree_node_allocator>
template <typename iter> iter stree<T, tree_node_allocator>::wrap(iter position, const T& x)
	{
	assert(position.node!=0);
...
template <class T, class tree_node_allocator>
template <typename iter> iter stree<T, tree_node_allocator>::move_after(iter target, iter source)
   {
...
template <class T, class tree_node_allocator>
template <typename iter> iter stree<T, tree_node_allocator>::move_before(iter target, iter source)
   {
   tree_node *dst=target.node;
   tree_node *src=source.node;
   assert(dst);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::move_before(sibling_iterator target, 
...
template <class T, class tree_node_allocator>
template <typename iter> iter stree<T, tree_node_allocator>::move_ontop(iter target, iter source)
	{
	tree_node *dst=target.node;
	tree_node *src=source.node;
	assert(dst);
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::merge(sibling_iterator to1,   sibling_iterator to2,
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::sort(sibling_iterator from, sibling_iterator to, bool deep)
	{
	std::less<T> comp;
...
template <class T, class tree_node_allocator>
template <class StrictWeakOrdering>
void stree<T, tree_node_allocator>::sort(sibling_iterator from, sibling_iterator to, 
...
template <class T, class tree_node_allocator>
template <typename iter>
bool stree<T, tree_node_allocator>::equal(const iter& one_, const iter& two, const iter& three_) const
	{
	std::equal_to<T> comp;
...
template <class T, class tree_node_allocator>
template <typename iter>
bool stree<T, tree_node_allocator>::equal_subtree(const iter& one_, const iter& two_) const
	{
	std::equal_to<T> comp;
...
template <class T, class tree_node_allocator>
template <typename iter, class BinaryPredicate>
bool stree<T, tree_node_allocator>::equal(const iter& one_, const iter& two, const iter& three_, BinaryPredicate fun) const
	{
...
template <class T, class tree_node_allocator>
template <typename iter, class BinaryPredicate>
bool stree<T, tree_node_allocator>::equal_subtree(const iter& one_, const iter& two_, BinaryPredicate fun) const
	{
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator> stree<T, tree_node_allocator>::subtree(sibling_iterator from, sibling_iterator to) const
	{
	stree tmp;
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::subtree(stree& tmp, sibling_iterator from, sibling_iterator to) const
	{
	tmp.set_head(value_type());
	tmp.replace(tmp.begin(), tmp.end(), from, to);
	}
...
template <class T, class tree_node_allocator>
size_t stree<T, tree_node_allocator>::size() const
	{
	size_t i=0;
...
template <class T, class tree_node_allocator>
size_t stree<T, tree_node_allocator>::size(const iterator_base& top) const
	{
	size_t i=0;
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::empty() const
	{
	pre_order_iterator it=begin(), eit=end();
	return (it==eit);
	}
...
template <class T, class tree_node_allocator>
int stree<T, tree_node_allocator>::depth(const iterator_base& it) 
	{
...
template <class T, class tree_node_allocator>
int stree<T, tree_node_allocator>::depth(const iterator_base& it, const iterator_base& root) 
	{
	tree_node* pos=it.node;
	assert(pos!=0);
	int ret=0;
...
template <class T, class tree_node_allocator>
int stree<T, tree_node_allocator>::max_depth() const
	{
	int maxd=-1;
...
template <class T, class tree_node_allocator>
int stree<T, tree_node_allocator>::max_depth(const iterator_base& pos) const
	{
	tree_node *tmp=pos.node;
...
template <class T, class tree_node_allocator>
unsigned int stree<T, tree_node_allocator>::number_of_children(const iterator_base& it) 
	{
...
template <class T, class tree_node_allocator>
unsigned int stree<T, tree_node_allocator>::number_of_siblings(const iterator_base& it) const
	{
	tree_node *pos=it.node;
	unsigned int ret=0;
	// count forward
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::swap(sibling_iterator it)
	{
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::swap(iterator one, iterator two)
	{
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::is_in_subtree(const iterator_base& it, const iterator_base& begin, 
																 const iterator_base& end) const
	{
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::is_valid(const iterator_base& it) const
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::iterator stree<T, tree_node_allocator>::lowest_common_ancestor(
...
template <class T, class tree_node_allocator>
unsigned int stree<T, tree_node_allocator>::index(sibling_iterator it) const
	{
	unsigned int ind=0;
	if(it.node->parent==0) {
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::sibling(const iterator_base& it, unsigned int num)
   {
   tree_node *tmp;
   if(it.node->parent==0) {
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::debug_verify_consistency() const
	{
	iterator it=begin();
	while(it!=end()) {
		if(it.node->parent!=0) {
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::child(const iterator_base& it, unsigned int num) 
	{
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::iterator_base::iterator_base()
	: node(0), skip_current_children_(false)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::iterator_base::iterator_base(tree_node *tn)
	: node(tn), skip_current_children_(false)
	{
	}

template <class T, class tree_node_allocator>
T& stree<T, tree_node_allocator>::iterator_base::operator*() const
	{
	return node->data;
	}
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::post_order_iterator::operator!=(const post_order_iterator& other) const
	{
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::pre_order_iterator::operator!=(const pre_order_iterator& other) const
	{
	if(other.node!=this->node) return true;
	else return false;
	}
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::sibling_iterator::operator!=(const sibling_iterator& other) const
	{
	if(other.node!=this->node) return true;
	else return false;
	}
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::leaf_iterator::operator!=(const leaf_iterator& other) const
   {
   if(other.node!=this->node) return true;
   else return false;
   }
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::iterator_base::begin() const
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::iterator_base::end() const
	{
	sibling_iterator ret(0);
	ret.parent_=node;
	return ret;
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::iterator_base::skip_children()
	{
	skip_current_children_=true;
	}

template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::iterator_base::skip_children(bool skip)
   {
   skip_current_children_=skip;
   }

template <class T, class tree_node_allocator>
unsigned int stree<T, tree_node_allocator>::iterator_base::number_of_children() const
	{
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::pre_order_iterator::pre_order_iterator() 
	: iterator_base(0)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::pre_order_iterator::pre_order_iterator(tree_node *tn)
	: iterator_base(tn)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::pre_order_iterator::pre_order_iterator(const iterator_base &other)
	: iterator_base(other.node)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::pre_order_iterator::pre_order_iterator(const sibling_iterator& other)
	: iterator_base(other.node)
	{
	if(this->node==0) {
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::pre_order_iterator& stree<T, tree_node_allocator>::pre_order_iterator::operator++()
	{
	assert(this->node!=0);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::pre_order_iterator stree<T, tree_node_allocator>::pre_order_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::pre_order_iterator& stree<T, tree_node_allocator>::pre_order_iterator::operator+=(unsigned int num)
	{
	while(num>0) {
		++(*this);
		--num;
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::post_order_iterator::post_order_iterator() 
	: iterator_base(0)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::post_order_iterator::post_order_iterator(tree_node *tn)
	: iterator_base(tn)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::post_order_iterator::post_order_iterator(const iterator_base &other)
	: iterator_base(other.node)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::post_order_iterator::post_order_iterator(const sibling_iterator& other)
	: iterator_base(other.node)
	{
	if(this->node==0) {
		if(other.range_last()!=0)
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::post_order_iterator& stree<T, tree_node_allocator>::post_order_iterator::operator++()
	{
	assert(this->node!=0);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::post_order_iterator stree<T, tree_node_allocator>::post_order_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::post_order_iterator& stree<T, tree_node_allocator>::post_order_iterator::operator+=(unsigned int num)
	{
	while(num>0) {
		++(*this);
		--num;
...
template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::post_order_iterator::descend_all()
	{
	assert(this->node!=0);
	while(this->node->first_child)
		this->node=this->node->first_child;
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::breadth_first_queued_iterator::breadth_first_queued_iterator()
	: iterator_base()
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::breadth_first_queued_iterator::breadth_first_queued_iterator(tree_node *tn)
	: iterator_base(tn)
	{
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::breadth_first_queued_iterator::breadth_first_queued_iterator(const iterator_base& other)
	: iterator_base(other.node)
	{
...
template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::breadth_first_queued_iterator::operator!=(const breadth_first_queued_iterator& other) const
	{
	if(other.node!=this->node) return true;
	else return false;
	}
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::breadth_first_queued_iterator& stree<T, tree_node_allocator>::breadth_first_queued_iterator::operator++()
	{
	assert(this->node!=0);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::breadth_first_queued_iterator stree<T, tree_node_allocator>::breadth_first_queued_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::breadth_first_queued_iterator& stree<T, tree_node_allocator>::breadth_first_queued_iterator::operator+=(unsigned int num)
	{
	while(num>0) {
		++(*this);
		--num;
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::fixed_depth_iterator::fixed_depth_iterator()
	: iterator_base()
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::fixed_depth_iterator::fixed_depth_iterator(tree_node *tn)
	: iterator_base(tn), top_node(0)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::fixed_depth_iterator::fixed_depth_iterator(const iterator_base& other)
	: iterator_base(other.node), top_node(0)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::fixed_depth_iterator::fixed_depth_iterator(const sibling_iterator& other)
	: iterator_base(other.node), top_node(0)
	{
	}

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::fixed_depth_iterator::fixed_depth_iterator(const fixed_depth_iterator& other)
	: iterator_base(other.node), top_node(other.top_node)
	{
	}

template <class T, class tree_node_allocator>
bool stree<T, tree_node_allocator>::fixed_depth_iterator::operator==(const fixed_depth_iterator& other) const
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::fixed_depth_iterator& stree<T, tree_node_allocator>::fixed_depth_iterator::operator++()
	{
	assert(this->node!=0);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::fixed_depth_iterator stree<T, tree_node_allocator>::fixed_depth_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::fixed_depth_iterator& stree<T, tree_node_allocator>::fixed_depth_iterator::operator-=(unsigned int num)
	{
	while(num>0) {
		--(*this);
		--(num);
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::sibling_iterator::sibling_iterator() 
	: iterator_base()
	{
	set_parent_();
	}
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::sibling_iterator::sibling_iterator(tree_node *tn)
	: iterator_base(tn)
	{
	set_parent_();
	}
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::sibling_iterator::sibling_iterator(const iterator_base& other)
	: iterator_base(other.node)
	{
	set_parent_();
	}
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::sibling_iterator::sibling_iterator(const sibling_iterator& other)
	: iterator_base(other), parent_(other.parent_)
	{
	}

template <class T, class tree_node_allocator>
void stree<T, tree_node_allocator>::sibling_iterator::set_parent_()
	{
	parent_=0;
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator& stree<T, tree_node_allocator>::sibling_iterator::operator++()
	{
	if(this->node)
		this->node=this->node->next_sibling;
	return *this;
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator stree<T, tree_node_allocator>::sibling_iterator::operator++(int)
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::sibling_iterator& stree<T, tree_node_allocator>::sibling_iterator::operator+=(unsigned int num)
	{
	while(num>0) {
		++(*this);
		--num;
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::tree_node *stree<T, tree_node_allocator>::sibling_iterator::range_first() const
	{
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::tree_node *stree<T, tree_node_allocator>::sibling_iterator::range_last() const
	{
...
template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::leaf_iterator::leaf_iterator() 
   : iterator_base(0), top_node(0)
   {
   }

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::leaf_iterator::leaf_iterator(tree_node *tn, tree_node *top)
   : iterator_base(tn), top_node(top)
   {
   }

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::leaf_iterator::leaf_iterator(const iterator_base &other)
   : iterator_base(other.node), top_node(0)
   {
   }

template <class T, class tree_node_allocator>
stree<T, tree_node_allocator>::leaf_iterator::leaf_iterator(const sibling_iterator& other)
   : iterator_base(other.node), top_node(0)
   {
   if(this->node==0) {
      if(other.range_last()!=0)
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::leaf_iterator& stree<T, tree_node_allocator>::leaf_iterator::operator++()
   {
	assert(this->node!=0);
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::leaf_iterator stree<T, tree_node_allocator>::leaf_iterator::operator++(int)
   {
...
template <class T, class tree_node_allocator>
typename stree<T, tree_node_allocator>::leaf_iterator& stree<T, tree_node_allocator>::leaf_iterator::operator+=(unsigned int num)
   {
   while(num>0) {
      ++(*this);
      --num;
